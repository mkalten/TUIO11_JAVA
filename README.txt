...
* getTuioObjects() returns an ArrayList of all currently present TuioObjects
* getTuioCursors() returns an ArrayList of all currently present TuioCursors
* getTuioBlobs() returns an ArrayList of all currently present TuioBlobs
